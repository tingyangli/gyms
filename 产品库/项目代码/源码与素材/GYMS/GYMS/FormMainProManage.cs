...
namespace GYMS
{
    public partial class FormMainProManage : Form
    {
        ...
        int PanelWidth;
        bool isCollapsed;
        public FormMainProManage(PersonModel _personModel)
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            AddcontrolstoPanel(userPerson);
        }

        private void button4_Click(object sender, EventArgs e)
        {
            movesidePanel(button4);
            UserGY userGY = new UserGY();
            AddcontrolstoPanel(userGY);
        }
